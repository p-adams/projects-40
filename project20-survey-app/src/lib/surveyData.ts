...
export const MOCK_SURVEY_RESPONSES = [
  {
    ...
    Location: "central_america",
    Satisfaction: "excellent",
    "Accommodation and Attractions": "yes_x",
    "Variety and Quality of Food": "neutral",
    Restaurants: "bronto",
    "Stone Age Attractions ": ["expedition", "coaster"],
    Amenities: ["pool"],
  ...
  },
  {
    ...
    Restaurants: "other",
    "Variety and Quality of Food": "very_satisfied",
    "Accommodation and Attractions": "yes_x",
    Satisfaction: "excellent",
  ...
  },
  {
    ...
    "Variety and Quality of Food": "very_satisfied",
    Restaurants: "cave",
    "Stone Age Attractions ": ["expedition", "race"],
    Amenities: ["pool", "treehouse"],
    Recommendations: "yes",
  },
];
